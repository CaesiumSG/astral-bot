module.exports = {
    name: "ytchannel",
    cooldown: 5,
    description: "search a youtube channel on discord",
    usage: "[message]",
    execute(message) {
        ...
        .setDescription(`channel search: ${MS}`)
        .addField('link', `[youtube channel](https://www.youtube.com/results?search_query=${MSG}&sp=EgIQAg%253D%253D)`)
        .setTimestamp()
